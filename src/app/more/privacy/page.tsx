    ...
    <Container size="md" py="xl">
      ...
      <Stack gap="xl">
        <Box>
          ...
          <Space h="xs" />
          <Text>
            오늘의아이 with김봉섭은(는) 다음의 목적을 위하여 개인정보를
          ...
          <Text ml="md">
            물품배송, 서비스 제공, 콘텐츠 제공을 목적으로 개인정보를 처리합니다.
          </Text>
        ...
        <Box>
          <Title order={3}>제2조(개인정보의 처리 및 보유 기간)</Title>
          <Space h="xs" />
          <Text>
            ① 오늘의아이 with 김봉섭은(는) 법령에 따른 개인정보 보유·이용기간
          ...
          <Text ml="md">보유근거 : 개인정보 민감 정보 1년 내 파기</Text>
          <Text ml="md">관련법령 : 표시/광고에 관한 기록 : 6개월</Text>
        </Box>
        ...
        <Box>
          ...
          <Space h="xs" />
          <Text>
            ① 오늘의아이 with 김봉섭은(는) 다음의 개인정보 항목을 처리하고
            있습니다.
          </Text>
          <Space h="xs" />
          <Text fw={500}>1. 홈페이지 회원가입 및 관리</Text>
          <Text ml="md">필수항목 : 이름, 비밀번호, 휴대전화번호</Text>
        ...
        <Box>
          <Title order={3}>제4조(개인정보의 파기절차 및 파기방법)</Title>
          <Space h="xs" />
          <Text>
            ① 오늘의아이 with 김봉섭은(는) 개인정보 보유기간의 경과, 처리목적
          ...
          <Text ml="md">2. 보존하는 개인정보 항목 : 계좌정보, 거래날짜</Text>
          <Text>③ 개인정보 파기의 절차 및 방법은 다음과 같습니다.</Text>
          <Text ml="md">1. 파기절차</Text>
          <Text ml="md">
            오늘의아이 with 김봉섭은(는) 파기 사유가 발생한 개인정보를 선정하고,
            오늘의아이 with 김봉섭의 개인정보 보호책임자의 승인을 받아
            개인정보를 파기합니다.
          </Text>
        </Box>
        ...
        <Box>
          ...
          <Space h="xs" />
          <Text>
            ① 정보주체는 오늘의아이 with 김봉섭에 대해 언제든지 개인정보
            열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.
          </Text>
          <Text>
            ② 제1항에 따른 권리 행사는 오늘의아이 with 김봉섭에 대해 「개인정보
            보호법」 시행령 제41조제1항에 따라 서면, 전자우편, 모사전송(FAX)
            등을 통하여 하실 수 있으며 오늘의아이 with 김봉섭은(는) 이에 대해
            지체 없이 조치하겠습니다.
          </Text>
          <Text>
          ...
          <Text>
            ⑥ 오늘의아이 with 김봉섭은(는) 정보주체 권리에 따른 열람의 요구,
        ...
        <Box>
          <Title order={3}>제11조(개인정보 보호책임자에 관한 사항)</Title>
          <Space h="xs" />
          <Text>
            ① 오늘의아이 with 김봉섭은(는) 개인정보 처리에 관한 업무를 총괄해서
        ...
        <Box>
          ...
          <Space h="xs" />
          <Text>① 이 개인정보처리방침은 2025년 5월 12일부터 적용됩니다.</Text>
          {/* <Text>
