  ...
  return (
    <>
        ...
        <div className="horizonFlexbox space-between">
          ...
          <div className="verticalFlexbox gap-7">
            <div className="horizonFlexbox align-center">
              ...
              <ArrowIcon direction="right" color="#9e9e9e" size={16} />
            </div>
            <div className="horizonFlexbox align-center justify-center">
              <img src="https://heidimoon.cafe24.com/renwal/test2/barcode.png" width="76px" height="76px" />
            </div>
          </div>
        </div>
      ...
      <Container className="homepage_1 gap-4">
        ...
        <img className={styles.homepage_image_1} src="https://heidimoon.cafe24.com/renwal/test2/Frame%2039.png" />
      </Container>
