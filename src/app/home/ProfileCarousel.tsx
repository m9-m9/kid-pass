      ...
      {profiles.map((kidRecord, index) => {
        ...
        return (
          <Carousel.Slide key={profile.chldrnNo} style={slidePadding}>
            ...
            >
              <Stack>
                <Flex gap={18} justify="space-between" align="start">
                  <ProfileMetrics
                    label={`${profile.chldrnBrthdy?.substring(0, 10)} 출생`}
                  ...
                  >
                    <Text
                      ...
                      fw="500"
                      c="#9e9e9e"
                      onClick={() => handleReport(profile.chldrnNo)}
                    >
                      리포트 상세보기
                    </Text>
                    <IconChevronRight
                ...
                <Stack gap={0}>
                  <ProfileMetrics label="나이 (만)" value={profile.age} />
                </Stack>
                <Flex align="center" justify="space-between">
                  ...
                  />
                  <Divider size="xs" color="#FFFFFF" orientation="vertical" />
                  <ProfileMetrics
                    label="키"
