...
const RecordForm = ({ type }: RecordFormProps) => {
  ...
  const handleSubmit = async (values: FormValues) => {
    try {
      ...
      if (!token || !currentKid || !values.startDate) {
        return;
      }
      ...
      >
        <Stack gap="xl" pb="md">
          {TYPE_TIP_MAP[type as keyof typeof TYPE_TIP_MAP] && (
            <Stack gap="xs">
              <Text fw={600} fz="md">
                {TYPE_TIP_MAP[type as keyof typeof TYPE_TIP_MAP].title}
              </Text>
              <Box bg="#FFEDED" p="sm" style={{ borderRadius: "8px" }}>
                <Text
                  fw={500}
                  fz="sm"
                  c="#FF6969"
                ...
                >
                  {TYPE_TIP_MAP[type as keyof typeof TYPE_TIP_MAP].tip}
                </Text>
              </Box>
            </Stack>
          )}
