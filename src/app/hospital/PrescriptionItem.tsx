	...
	return (
		...
		>
			...
			<Flex align="center" mb={theme.spacing.sm}>
				...
				<Text  w="50%"fz="md" fw={500 }c={theme.other.fontColors.sub3}>
			...
			<Text  w="50%" fw={600} fz="1.125rem" c={theme.other.fontColors.primary}>
					{item.diagnoses}
				</Text>
				<Text fw={600} fz="1.125rem" c={theme.other.fontColors.sub3}>
					{item.medicines}
				</Text>
			</Flex>
			</Box>
			<Box mt="lg" display="flex" style={{flexDirection:"column" ,gap:"12px"}}>
			<Text fw={600} fz="1.125rem" c={theme.other.fontColors.primary} >처방전 이미지</Text>
