    ...
    <>
      <div>
        ...
        <div className={styles.sectionContainer}>
          ...
          <MetricsItem title="체온기록" isOpen={openStates.temp} onToggle={() => toggleMetricsArea("temp")}>
            <BodyTemp />
          </MetricsItem>

          <MetricsItem title="수면패턴" isOpen={openStates.sleep} onToggle={() => toggleMetricsArea("sleep")}>
            <MetricsDetailItem label="간격" value="3회" />
            <MetricsDetailItem label="횟수" value="6회" />
          </MetricsItem>
          <MetricsItem title="식사패턴" isOpen={openStates.meal} onToggle={() => toggleMetricsArea("meal")}>
            <MetricsDetailItem label="간격" value="2시간" />
            <MetricsDetailItem label="횟수" value="6회" />
          </MetricsItem>
          <MetricsItem title="식사패턴" isOpen={openStates.urination} onToggle={() => toggleMetricsArea("urination")}>
